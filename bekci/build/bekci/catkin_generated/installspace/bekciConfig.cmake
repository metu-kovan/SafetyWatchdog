...
if("FALSE" STREQUAL "TRUE")
  set(bekci_SOURCE_PREFIX /home/fatih/bekci/src/bekci)
  set(bekci_DEVEL_PREFIX /home/fatih/bekci/devel)
  set(bekci_INSTALL_PREFIX "")
  set(bekci_PREFIX ${bekci_DEVEL_PREFIX})
else()
  set(bekci_SOURCE_PREFIX "")
  set(bekci_DEVEL_PREFIX "")
  set(bekci_INSTALL_PREFIX /home/fatih/bekci/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bekci' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fatih/bekci/install/${idir}'.  Ask the maintainer 'fatih <fatih@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fatih/bekci/install/lib;/home/fatih/ur5/devel/lib;/opt/ros/indigo/lib)
...
set(depends "roscpp;std_msgs;actionlib_msgs;control_msgs;actionlib")
