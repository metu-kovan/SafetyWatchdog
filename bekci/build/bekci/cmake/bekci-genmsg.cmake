...
message(STATUS "bekci: 6 messages, 0 services")
...
get_filename_component(_filename "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/SpaceSafetyStatus.msg" NAME_WE)
add_custom_target(_bekci_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bekci" "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/SpaceSafetyStatus.msg" ""
)

get_filename_component(_filename "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/Pose.msg" NAME_WE)
add_custom_target(_bekci_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bekci" "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/Pose.msg" ""
)

get_filename_component(_filename "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/QuantativeSafetyStatus.msg" NAME_WE)
add_custom_target(_bekci_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bekci" "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/QuantativeSafetyStatus.msg" ""
)

get_filename_component(_filename "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/JointVelocity.msg" NAME_WE)
add_custom_target(_bekci_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bekci" "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/JointVelocity.msg" ""
)

get_filename_component(_filename "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/JointPose.msg" NAME_WE)
add_custom_target(_bekci_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bekci" "/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/msg/JointPose.msg" "bekci/Pose"
)
