...
struct MD5Sum< ::bekci::JointPose_<ContainerAllocator> >
{
  ...
  {
    return "19abeb982f48e5effbac09d592bc2f48";
  }

  static const char* value(const ::bekci::JointPose_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x19abeb982f48e5efULL;
  static const uint64_t static_value2 = 0xfbac09d592bc2f48ULL;
};
