...
if(NOT "/home/fatih/git/GuvenlikBekcisi/bekci/devel/include;/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bekci' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fatih/git/GuvenlikBekcisi/bekci/src/bekci/${idir}'.  Ask the maintainer 'fatih <fatih@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fatih/git/GuvenlikBekcisi/bekci/devel/lib;/home/fatih/git/GuvenlikBekcisi/bekci/devel/lib;/home/fatih/universal_robotics/devel/lib;/opt/ros/indigo/lib)
